    ...
    if(key != null){
        ...
        if(resSearch.flag == 'success'){
            ...
            for(var i=0;i<dataSearch.length;i++){
                ...
                inner += '<a href="informationDetails.html?id='+dataSearch[i].consultId+'" target="_blank" class="market_t_l_message"><div class="img fl"><img src="'+imgSearch+'" alt="图片"/></div><div class="title fl"><h2>'+dataSearch[i].consultTitle+'</h2><p>'+dataSearch[i].consultIntroduce+'</p></div></a>';
            }
