    ...
    if(key != null){
        ...
        if(resSearch.flag == 'success'){
            ...
            for(var i=0;i<dataSearch.length;i++){
                ...
                inner += '<a href="marketingDetails.html?id='+dataSearch[i].marketId+'" target="_blank" class="market_t_l_message"><div class="img fl"><img src="'+imgSearch+'" alt="图片"/></div><div class="title fl"><h2>'+dataSearch[i].marketTitle+'</h2><p>'+dataSearch[i].marketIntroduce+'</p></div></a>';
            }
