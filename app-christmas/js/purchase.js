    ...
    if(key != null){
        ...
        if(resSearch.flag =='success'){
            ...
            for(var i=0;i<dataSearch.length;i++){
                ...
                html += '<a href="purchaseDetails.html?id='+dataSearch[i].procurementId+'" target="_blank" class="market_t_l_message"><div class="img fl"><img src="'+imgSearch+'"/></div><div class="title fl"><h2>'+dataSearch[i].procurementTitle+'</h2><p>'+dataSearch[i].procurementIntroduce+'</p></div></a>';
            }
